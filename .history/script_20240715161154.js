...
agendarButtons.forEach((button) => {
  button.addEventListener("click", function (event) {
    ...
    const duration = button.parentNode.querySelector("#tempo").textContent.trim(); // Renomeado para duration
    ...
    document.querySelector('#scheduleForm input[name="duration"]').value = duration; // Envia duration ao invés de tempo
  });
});
